...
/* ---------------------- Integration tests ----------------------- */
    ...
    TEST_EQUALS(result, itemCompare(item1,item1_copy),ITEM_EOUAL);
    TEST_DIFFERENT(result, itemCompare(item1,item2),ITEM_EOUAL);
    ...
    TEST_EQUALS(result,itemCompare(item_bag1,item1),ITEM_EOUAL);
    TEST_EQUALS(result,sellItem(our_store,item6,&item_bag2),STORE_SUCCESS);
    TEST_EQUALS(result,itemCompare(item_bag2,item6),ITEM_EOUAL);
