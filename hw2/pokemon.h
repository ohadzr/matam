...
/*
* Modifications since publishing (comments only):
* 23.11.2016: fixed the formula description of pokemonHeal.
*/
...
* If the function succeeds, the following happens:
* 1. The health points of the pokemon change to: (100+pokemon_level)*10.
